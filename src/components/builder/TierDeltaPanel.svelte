...
<style>
  .tier-delta { border: 1px solid var(--sl-color-hairline); font-family: var(--sl-font-mono); margin-bottom: .9rem; } .tier-delta > * { margin: 0; min-width: 0; }
  ...
  .delta-copy { display: grid; grid-template-columns: 1fr 1fr; } .delta-copy > div { margin: 0; min-width: 0; padding: .6rem; } .delta-copy > div + div { border-left: 1px solid var(--sl-color-hairline); } small { color: var(--sl-color-gray-3); display: block; font-size: .52rem; font-weight: 800; letter-spacing: .08em; } .current small { color: var(--tear-cyan); } p { color: var(--sl-color-gray-2); font-family: var(--sl-font); font-size: .68rem; line-height: 1.4; margin: .4rem 0 0; text-transform: none; }
